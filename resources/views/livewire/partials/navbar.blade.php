<nav x-data="{ mobileMenuOpen: false, searchOpen: false }" x-cloak
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('client.blogs') }}"
                    class="text-white hover:text-purple-300 transition-colors font-medium">Blogs</a>
                <a href="{{ route('client.reviews') }}"
                    class="text-white hover:text-purple-300 transition-colors font-medium">Reviews</a>
        ...
        <div x-show="searchOpen" x-transition:enter="transition ease-out duration-200"
            ...
            x-transition:leave-end="opacity-0 -translate-y-2" class="pb-4">
            <div class="relative">
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="px-4 py-6 space-y-4">
            ...
            <a href="{{ route('client.reviews') }}"
                class="block text-white hover:text-purple-300 transition-colors font-medium py-2">Reviews</a>
            <a href="{{ route('client.contact') }}"
